  ...
  return (
    <div className={s.wrapper}>
      <div>
        ...
        <button className={s.btn} onClick={() => dispatch(basket_add(id))}>
      ...
      {discont_price !== null ? (
        <p className={s.price}>
          {" "}
          <b className={s.newPrice}>{discont_price}$</b>{" "}
          <span className={s.oldPrice}>{price}$</span>{" "}
          <span className={s.percent}>-{precent}%</span>
        </p>
      ) : (
        <p className={s.price}>
          {" "}
          <b className={s.newPrice}>{price}$</b>
        </p>
      )}
